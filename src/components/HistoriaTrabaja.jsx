...
function Tab({ active, onClick, subtitle, title, accent }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`w-full text-left rounded-2xl border p-5 sm:p-6 transition-all duration-200 ${
        active
  ...
  return (
    <section id="trabaja" className="relative bg-[#FAFBFC] py-16 sm:py-24 scroll-mt-4">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className={`grid transition-all duration-300 ease-in-out ${active ? 'grid-rows-[1fr] opacity-100 mt-3 sm:mt-4' : 'grid-rows-[0fr] opacity-0'}`}>
