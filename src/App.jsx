    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center space-y-4">
          <img src="/assets/logo-icon.png" alt="SARO" className="h-20 mx-auto" />
        ...
        <footer className="bg-white border-t border-gray-100 mt-12 py-8 px-4">
          <div className="max-w-7xl mx-auto text-center space-y-3">
            ...
            <p className="text-[10px] text-gray-300">
              Ropa deportiva mayorista &middot; Pádel &middot; Accesorios &middot; Entrenamiento &middot; Argentina
            </p>
          </div>
        </footer>
      </div>
